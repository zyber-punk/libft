...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/11/28 20:40:55 by uzyberaj          #+#    #+#             */
/*   Updated: 2024/12/04 14:04:22 by uzyberaj         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	ft_lstiter(head -> next, free);
	printf("\nListe après free des noeuds apres head :\n");
	printf("Content: %s | Address: %p\n", (char *)head->content, head);
	printf("Content: %s | ", (char *)head->next->content);
	printf("Address: %p\n", head->next);
	printf("Content: %s | ", (char *)head->next->next->content);
	printf("Address: %p\n", head->next->next);
	printf("Content: %p\n", head->next->next->next);
